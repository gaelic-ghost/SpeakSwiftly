...
- The Swift probe now also supports a resident bucket catalog with repeatable `--bucket-model` entries. The refreshed catalog run loaded bucket 72 and bucket 88 once in the same process, routed prompt-001 to bucket 72 at about `83.8 ms`, routed prompt-002 to bucket 88 at about `107.9 ms`, and recorded process RSS rising from about `22 MiB` at start to about `630 MiB` after both predictions.

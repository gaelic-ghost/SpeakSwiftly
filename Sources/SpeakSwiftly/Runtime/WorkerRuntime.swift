...
public extension SpeakSwiftly {
    ...
    private enum GenerationJobDisposition: Sendable, Equatable {
        case run
        case skip
        case park(GenerationParkReason)
    }

    private func generationDisposition(
    ...
    private func maximumConcurrentGenerationJobs(
    ...
    private func isLiveSpeechGenerationRequest(_ request: WorkerRequest) -> Bool {
        if case .queueSpeech(
            id: _,
            text: _,
            profileName: _,
    ...
    private func isBlockedByProfileCreation(

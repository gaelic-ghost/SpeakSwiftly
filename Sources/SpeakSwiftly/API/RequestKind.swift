...
public extension SpeakSwiftly {
    ...
    struct RequestKind: RawRepresentable, Codable, Sendable, Equatable, Hashable {
        ...
        public static let listRecentGeneratedAudio = Self(rawValue: "list_recent_generated_audio")
        public static let getRecentGeneratedAudioChunks = Self(rawValue: "get_recent_generated_audio_chunks")
        public static let replayRecentAudioAll = Self(rawValue: "replay_recent_audio_all")
        public static let clearRecentGeneratedAudio = Self(rawValue: "clear_recent_generated_audio")

...
`docs/maintainers/coreml-qwen3tts/coreai-talker-boundary-plan-12hz.json`. It is
generated by:
...
`docs/maintainers/coreml-qwen3tts/coreai-real-boundary-plan-12hz.json`. It is
generated by:
...
uv run --script scripts/repo-maintenance/coreml-qwen3tts/probe-coreai-talker-boundary.py \
  ...
  --created-at-utc 2026-06-23T00:00:00Z \
  --report docs/maintainers/coreml-qwen3tts/coreai-real-boundary-plan-12hz.json
```

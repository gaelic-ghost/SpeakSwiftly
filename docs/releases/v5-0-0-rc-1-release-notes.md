...
- Kept `source_format` as the JSONL whole-source selector and `request_context`
  as the JSONL metadata and path-context container.
...
- Full package validation and release-safe E2E verification are tracked in
  `docs/releases/v5-0-0-rc-1-release-prep.md`.
